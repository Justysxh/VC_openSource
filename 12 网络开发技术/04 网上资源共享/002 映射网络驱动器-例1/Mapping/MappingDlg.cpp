...
void CMappingDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, m_drive);
...
BEGIN_MESSAGE_MAP(CMappingDlg, CDialog)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTJOIN, OnButjoin)
...
void CMappingDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMappingDlg::OnQueryDragIcon()
{
