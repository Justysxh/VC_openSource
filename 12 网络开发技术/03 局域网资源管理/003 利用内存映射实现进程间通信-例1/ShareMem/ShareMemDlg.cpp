...
void CShareMemDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_WRITEEDIT, m_Write);
	DDX_Control(pDX, IDC_READEDIT, m_Read);
	//}}AFX_DATA_MAP
}
...
BOOL CShareMemDlg::OnInitDialog()
{
	...
	m_hShareMem = CreateFileMapping((HANDLE)0xffffffff,NULL,PAGE_READWRITE,0,10000,"MemFile");
