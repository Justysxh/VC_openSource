// MultiComboBoxDlg.cpp : implementation file
//
...
{
	//{{AFX_DATA_INIT(CMultiComboBoxDlg)
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMultiComboBoxDlg)
	DDX_Control(pDX, IDC_MULCMB, m_mulcmb);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMultiComboBoxDlg, CDialog)
	//{{AFX_MSG_MAP(CMultiComboBoxDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CMultiComboBoxDlg message handlers
