...
BOOL CDragDlg::OnInitDialog()
{
	...
	m_Grid.SetExtendedStyle(LVS_EX_FLATSB
		...
		|LVS_EX_GRIDLINES);
	m_Grid.InsertColumn(0,"员工编号",LVCFMT_LEFT,100);
	m_Grid.InsertColumn(1,"员工姓名",LVCFMT_LEFT,100);
	m_Grid.InsertColumn(2,"文化程度",LVCFMT_LEFT,100);
	m_Grid.InsertItem(0,"0001");
	m_Grid.SetItemText(0,1,"赵一");
	m_Grid.SetItemText(0,2,"专科");
	m_Grid.InsertItem(1,"0002");
	m_Grid.SetItemText(1,1,"钱二");
	m_Grid.SetItemText(1,2,"本科");
	m_Grid.InsertItem(2,"0003");
	m_Grid.SetItemText(2,1,"孙三");
	m_Grid.SetItemText(2,2,"研究生");
