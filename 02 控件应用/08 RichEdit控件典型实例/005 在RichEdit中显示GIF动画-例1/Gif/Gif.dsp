...
!MESSAGE "Gif - Win32 Unicode Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Gif - Win32 Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Gif - Win32 Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Gif - Win32 Unicode Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Gif - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\Gif.dll
InputPath=.\Debug\Gif.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Gif - Win32 Unicode Debug"
...
# Begin Custom Build - Performing registration
OutDir=.\DebugU
TargetPath=.\DebugU\Gif.dll
InputPath=.\DebugU\Gif.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Gif - Win32 Release MinSize"
...
TargetPath=.\ReleaseMinSize\Gif.dll
InputPath=.\ReleaseMinSize\Gif.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Gif - Win32 Release MinDependency"
...
TargetPath=.\ReleaseMinDependency\Gif.dll
InputPath=.\ReleaseMinDependency\Gif.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Gif - Win32 Unicode Release MinSize"
...
TargetPath=.\ReleaseUMinSize\Gif.dll
InputPath=.\ReleaseUMinSize\Gif.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Gif - Win32 Unicode Release MinDependency"
...
TargetPath=.\ReleaseUMinDependency\Gif.dll
InputPath=.\ReleaseUMinDependency\Gif.dll
SOURCE="$(InputPath)"
...
# Name "Gif - Win32 Unicode Debug"
# Name "Gif - Win32 Release MinSize"
# Name "Gif - Win32 Release MinDependency"
# Name "Gif - Win32 Unicode Release MinSize"
# Name "Gif - Win32 Unicode Release MinDependency"
...
SOURCE=.\Gif.idl
# ADD MTL /tlb ".\Gif.tlb" /h "Gif.h" /iid "Gif_i.c" /Oicf
# End Source File
# Begin Source File
