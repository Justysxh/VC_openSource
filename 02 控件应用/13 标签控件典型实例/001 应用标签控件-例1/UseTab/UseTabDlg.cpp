// UseTabDlg.cpp : implementation file
//
...
CUseTabDlg::CUseTabDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CUseTabDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CUseTabDlg)
...
void CUseTabDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CUseTabDlg)
	DDX_Control(pDX, IDC_TAB1, m_Tab);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CUseTabDlg, CDialog)
	//{{AFX_MSG_MAP(CUseTabDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CUseTabDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CUseTabDlg::OnQueryDragIcon()
{
