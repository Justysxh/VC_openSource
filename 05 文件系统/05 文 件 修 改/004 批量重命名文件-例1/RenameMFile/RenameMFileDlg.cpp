// RenameMFileDlg.cpp : implementation file
//
...
CRenameMFileDlg::CRenameMFileDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CRenameMFileDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CRenameMFileDlg)
...
void CRenameMFileDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CRenameMFileDlg)
	DDX_Control(pDX, IDC_FILELIST, m_filelist);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CRenameMFileDlg, CDialog)
	//{{AFX_MSG_MAP(CRenameMFileDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTADDFILE, OnAddFile)
	ON_BN_CLICKED(IDC_BTRENAME, OnReName)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CRenameMFileDlg message handlers
...
void CRenameMFileDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CRenameMFileDlg::OnQueryDragIcon()
{
