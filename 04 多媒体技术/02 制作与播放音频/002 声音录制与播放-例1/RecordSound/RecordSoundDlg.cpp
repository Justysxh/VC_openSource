...
CRecordSoundDlg::CRecordSoundDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CRecordSoundDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CRecordSoundDlg, CDialog)
	//{{AFX_MSG_MAP(CRecordSoundDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BTRECORD, OnRecord)
	ON_BN_CLICKED(IDC_BTPLAY, OnPlay)
...
void CRecordSoundDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CRecordSoundDlg::OnQueryDragIcon()
{
