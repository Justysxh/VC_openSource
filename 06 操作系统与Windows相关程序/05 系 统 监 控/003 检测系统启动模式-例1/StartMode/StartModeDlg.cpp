// StartModeDlg.cpp : implementation file
//
...
CStartModeDlg::CStartModeDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CStartModeDlg::IDD, pParent)
{
...
void CStartModeDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CStartModeDlg::OnQueryDragIcon()
{
