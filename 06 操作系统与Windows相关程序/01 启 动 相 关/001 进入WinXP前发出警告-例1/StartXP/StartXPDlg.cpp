// StartXPDlg.cpp : implementation file
//

#include "stdafx.h"
#include "StartXP.h"
#include "StartXPDlg.h"
...
CStartXPDlg::CStartXPDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CStartXPDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CStartXPDlg)
...
void CStartXPDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CStartXPDlg)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CStartXPDlg, CDialog)
	//{{AFX_MSG_MAP(CStartXPDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CStartXPDlg message handlers

BOOL CStartXPDlg::OnInitDialog()
{
...
void CStartXPDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CStartXPDlg::OnQueryDragIcon()
{
