...
#ifndef __WINSERVICELib_LIBRARY_DEFINED__
#define __WINSERVICELib_LIBRARY_DEFINED__

/* library WINSERVICELib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_WINSERVICELib;
#endif /* __WINSERVICELib_LIBRARY_DEFINED__ */
