...
DataManageDlg.h, DataManageDlg.cpp - the dialog
    These files contain your CDataManageDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in DataManage.rc, which can be edited in Microsoft
	Visual C++.
