...
void CDeletedataDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CDeletedataDlg::OnQueryDragIcon()
{
...
void CDeletedataDlg::OnOK() 
{
	...
	_bstr_t sql;
	sql = "delete from kjbdsjk  where ÐÕÃû='"+m_name+"' ";
