// ReverseColorDlg.cpp : implementation file
//
...
CReverseColorDlg::CReverseColorDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CReverseColorDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CReverseColorDlg)
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CReverseColorDlg)
	DDX_Control(pDX, IDC_IMAGE, m_image);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CReverseColorDlg, CDialog)
	//{{AFX_MSG_MAP(CReverseColorDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CReverseColorDlg message handlers

BOOL CReverseColorDlg::OnInitDialog()
{
...
void CReverseColorDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CReverseColorDlg::OnQueryDragIcon()
{
