...
NewFileInclude2=#include "Snail.h"
LastPage=0
...
Type=0
HeaderFile=Snail.h
ImplementationFile=Snail.cpp
Filter=N

[CLS:CSnailDoc]
Type=0
HeaderFile=SnailDoc.h
ImplementationFile=SnailDoc.cpp
Filter=N

[CLS:CSnailView]
Type=0
HeaderFile=SnailView.h
ImplementationFile=SnailView.cpp
Filter=C
