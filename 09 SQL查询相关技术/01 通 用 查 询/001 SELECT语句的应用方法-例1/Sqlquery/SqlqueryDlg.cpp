...
void CSqlqueryDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CSqlqueryDlg::OnQueryDragIcon()
{
...
void CSqlqueryDlg::OnOK() 
{
	...
	m_adodc.SetRecordSource("select*from kjbdsjk where "+str+"='"+m_edit+"'");
	m_adodc.Refresh();
	//CDialog::OnOK();
}
